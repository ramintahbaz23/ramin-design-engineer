  ...
  const description = (
    <>
      <p className="mb-2 sm:mb-3">
        A hardware startup focused on creating innovative keyboard solutions.
      </p>
    </>
  );
